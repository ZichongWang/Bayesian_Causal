...
% ith_percentile_temp = 0:0.01:1;
% ith_percentile = [];
% for l = 1:(length(ith_percentile_temp)-1)
%     ith_percentile = [ith_percentile,linspace(ith_percentile_temp(l),ith_percentile_temp(l+1),10)];
% end
